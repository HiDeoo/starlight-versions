...
You will also need to have some documentation pages ready to be versioned.
The plugin takes care of automatically archiving the current state of your documentation when you install it and create a new version.
Check the [“Versioning process”](/guides/about-versioning/#versioning-process) guide to learn more about how versioning works with the Starlight Versions plugin.
